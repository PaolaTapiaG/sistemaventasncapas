...
namespace SistemasVentas.DAL
{
    public class UsuarioDal
    {
        ...
        {
            string consulta = "SELECT USUARIO.IDUSUARIO, (PERSONA.NOMBRE+''+PERSONA.APELLIDO) NOMBRECOMPLETO, ROL.NOMBRE AS NOMBREROL, USUARIO.NOMBREUSER, USUARIOROL.FECHAASIGNA " +
